<template>
	<div class="demo-picker-container">
	  <mu-slide-picker :slots="addressSlots" :visible-item-count="3" @change="addressChange" :values="address"></mu-slide-picker>
	  <p>
...
const dataSource = require('./citysAreas.json')
console.log('dataSource:\n', dataSource)
let data = dataSource.map.data
let citys = []
let delIndex = []
...
let remainData = data.filter((item, index) => {
	return delIndex.indexOf(index) < 0
})
...
function dgs (data) {
	data.forEach(city => {
		...
		if (city.children) {
			city.children = getAllChildElesByBillNo(currentBillNo, remainData)
			dgs(city.children)
		}
	})
}
